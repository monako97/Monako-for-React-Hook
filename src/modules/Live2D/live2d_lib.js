!function (t) {
    ...
    r.prototype.getModelMatrix = function () {
        ...
        const u = this.modelMatrix.invertTransformX(i), p = this.modelMatrix.invertTransformY(e);
        ...
        let f;
        const i = new o, e = c.getPlatformManager(), r = e.jsonParseFromBytes(t);
        ...
        const s = r.params, _ = s.length;
        i.paramList = [];
        for (let a = 0; a < _; a++) {
            let h = s[a], l = h.id.toString(), $ = parseFloat(h.val), u = o.TYPE_ADD,
                p = null != h.calc ? h.calc.toString() : "add";
            if ((u = "add" === p ? o.TYPE_ADD : "mult" === p ? o.TYPE_MULT : "set" === p ? o.TYPE_SET : o.TYPE_ADD) === o.TYPE_ADD) {
                f = null == h.def ? 0 : parseFloat(h.def);
                $ -= f
            } else if (u == o.TYPE_MULT) {
                f = null == h.def ? 1 : parseFloat(h.def);
                0 == f && (f = 1), $ /= f
            }
            var d = new n;
    ...
    function n(t) {
        ...
        if (window.Live2D.captureFrame = !1, B = new M.L2DViewMatrix, B.setScreenRect(o, n, _, h), B.setMaxScreenRect(w.default.VIEW_LOGICAL_MAX_LEFT, w.default.VIEW_LOGICAL_MAX_RIGHT, w.default.VIEW_LOGICAL_MAX_BOTTOM, w.default.VIEW_LOGICAL_MAX_TOP), B.setMaxScale(w.default.VIEW_MAX_SCALE), B.setMinScale(w.default.VIEW_MIN_SCALE), U = new M.L2DMatrix44, U.multScale(1, i / e), G = new M.L2DMatrix44, G.multTranslate(-i / 2, -e / 2), G.multScale(2 / i, -2 / i), F = v(), (0, D.setContext)(F), !F) return console.error("Failed to create WebGL store."), void (window.WebGLRenderingContext && console.error("Your browser don't support WebGL, check https://get.webgl.org/ for futher information."));
